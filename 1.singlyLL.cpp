...
class single_llist
{
	...
	void single_llist::insert_begin()
	{
		...
		else
		{
			  ...
			  start=temp;
			  start->next=s;
			  cout<<temp->info<<"is finished at first"<<endl;
	...
	void single_llist::insert_last()
	{
		...
		else
		{
			...
			temp->next=NULL;
			s->next=temp;
			cout<<temp->info<<"is innnsrted at last"<<endl;
		...
		{
			   int value,pos,counter=0,loc=1,i;
			   ...
			   if(counter==0){}
			   	...
			   	cout<<"Ener the position from "<<loc<<"to"<<counter+1<<":";
			   	cin>>pos;
			   	s=start;
			   	if(pos==1)
			   	{
				...
				void single_llist::delete_pos()
				{
					...
					else
					{
						...
						else
						{
							  ...
							  {
							  	start=s->next;
							  	cout<<s->info<<"deleted from list"<<endl;
							  	free(s);
						       }
						       else if (pos>1&&pos<=counter)
						       {
					...
					void single_llist::update_begin()
					{
						...
						else if(pos==1)
						{
							...
							cin>>value;
							start->info=value;
							cout<<"Node updated at first posoition:"<<pos<<"="<<start->info<<endl;
